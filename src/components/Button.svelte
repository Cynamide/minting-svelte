...
<div class="flex flex-col">
  {#if !solana}
    <button
      class=" px-3 py-2 rounded-md  bg-[#6B3B43]  hover:bg-[#B56572] text-white font-bold"
  ...
  {:else if isSoldOut}
    <button
      class=" px-3 py-2 rounded-md  bg-[#6B3B43]  hover:bg-[#B56572] text-[#6B3B43] font-bold "
      >Sold Out!</button
    >
  ...
  {:else if $userState.userBalance < nftPrice()}
    <button
      class=" px-3 py-2 rounded-md  bg-[#6B3B43]  hover:bg-[#B56572] text-white font-bold disabled:bg-[#B56572]"
      disabled={true}
